...
| ***  | 蒙圈了 还是理不清组件 路由那块的 调用 理不清哪往哪调         |
| ---- | ------------------------------------------------------------ |
| ***  | 老师 能不能讲的稍微慢点啊 大脑的运转跟不上你的手速           |
| ***  | 唉，练吧                                                     |
| ***  | 老师，梳理一下各个文件之间的串联关系吧，有点不知道什么在main.js中写，什么在app.vue中写； |
| ***  | 代码部分可以多写一点备注                                     |
| ***  | 之前学组件和路由还没有彻底的熟练啊，今天就频繁的使用，有点懵 |
| ***  | 上午:emmmmmm...真简单 ....... 下午:?????????????这上午讲过吗????????? |
| ***  | 路由嵌套听得真的很迷，再就是编辑那一部分还理解的不是很清楚！！ |
| ***  | 今天真的是感觉吃了一斤的懵逼果                               |
| ***  | 准备工作第一次做，有点吼不住，后面又被来回切换文件给整蒙蔽了 ，不过嵌套倒是清楚 |
| ***  | 老师 我难受啊 我太难了 我特别想都会 但是我的脑细胞不允许我这么做啊 跪求老师帮我一下 |
| ***  | 路由嵌套，组件嵌套，嵌套，嵌套，嵌套，嵌套！！！awsl         |
| ***  | 全选D就对了                                                  |
| ***  | 由于某种不可抗力 听课失败 完全跟不上节奏了........... a w s l |
| ***  | 问题一 为什么app.vue和router.js接收的地址要分来写,怎么联系到一起的 问题二 list容器是怎么链接到app.vue并体现到页面上的,通过什么连接的 <router-view></router-view> // 加入承载视图 |
| ***  | 就是不太明白                                                 |
